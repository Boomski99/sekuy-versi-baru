...
def tambahVideo(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('teachers:list_video')
    ...
    return render(request,'classroom/teachers/tambahvideo.html',context)
...
def updateVideo(request,update_id):
    ...
    return render(request,'classroom/teachers/videopembelajaran.html',context)
...
def createMateri(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('teachers:list_materi')
    ...
    return render(request,'classroom/teachers/tambahmateri.html',context)
...
def listMateri(request):
    ...
    return render(request,'classroom/teachers/materi.html',context)


def listVideoPembelajaran(request):
    semua_video = VideoPembelajaran.objects.all()
